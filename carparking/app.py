...
def upload():
    ...
    video.save(r"C:\Users\ajay m\Desktop\AI-Enabled-car-parking-System\AI Enabled Car Parking System using OpenCV\carparking\input"+video_name)
...
def liv_pred():
    try: 
        cap = cv2.VideoCapture(r"C:\Users\ajay m\Desktop\AI-Enabled-car-parking-System\AI Enabled Car Parking System using OpenCV\carparking\input"+video_name)
        width, height = 107, 48
        
        with open(r'C:\Users\ajay m\Desktop\AI-Enabled-car-parking-System\AI Enabled Car Parking System using OpenCV\carparking\carparkpos', 'rb') as f:
